...
1. Explain what a token is used for.
   A token is used for security and authentication.

2. What steps can you take in your web apps to keep your data secure?
   You can encrypt your login pages, enforce stronger password policies for your web apps, and keeping it up to date.

3. Describe how web servers work.
   Web Servers are run by a computer program that distributes the web pages to users who sent a request for the page.
